...
- [Petmily Android Application 기능 구현](#petmily-android-application------)
  * [목차](#--)
    + [Client 부문](#client---)
    + [Server 부문](#server---)
  * [Client 부문](#client----1)
  * [각 액티비티 기능 설명](#------------)
  * [로딩 화면](#-----)
      - [splashActivity.kt](#splashactivitykt)
  * [메인 화면](#-----)
      - [MainActivity.kt](#mainactivitykt)
  * [홈 화면](#----)
      - [HomeFragment.kt](#homefragmentkt)
    + [로그인](#---)
      - [구글 로그인](#------)
    + [날씨](#--)
      - [WeatherAPIClient.kt](#weatherapiclientkt)
      - [WeatherAPIService.kt](#weatherapiservicekt)
      - [RemoteDataSourceImpl.kt](#remotedatasourceimplkt)
      - [HomeFragment.kt 날씨 띄우기](#homefragmentkt-------)
  * [동물 감정 분석](#--------)
      - [AnalysisFragment.kt](#analysisfragmentkt)
      - [ResultFragment.kt](#resultfragmentkt)
  * [커뮤니티](#----)
    + [게시물 가져오기](#--------)
      - [PostFragment.kt](#postfragmentkt)
      - [RetrofitService](#retrofitservice)
      - [게시물 가져오기 getPost](#---------getpost)
    + [게시물 작성](#------)
      - [PostUploadFragment.kt](#postuploadfragmentkt)
      - [postUpload](#postupload)
    + [좋아요](#---)
      - [PostLikeFragment.kt](#postlikefragmentkt)
      - [LikeRetrofitService](#likeretrofitservice)
      - [좋아요 표시 postLike](#-------postlike)
      - [좋아요 삭제 deleteData](#-------deletedata)
      - [좋아요 개수 getCountLike](#-------getcountlike)
      - [좋아요 했는지 확인 aboutLike](#-----------aboutlike)
    + [좋아요 모아보기](#--------)
      - [PostUploadFragment.kt](#postuploadfragmentkt-1)
    + [댓글](#--)
      - [CommentFragment.kt](#commentfragmentkt)
  * [산책](#--)
    + [산책 저장 확인](#--------)
      - [WalkFragment.kt](#walkfragmentkt)
      - [DetailTrackingFragment.kt](#detailtrackingfragmentkt)
    + [실시간 산책 기록](#---------)
      - [TrackingFragment.kt](#trackingfragmentkt)
  * [장소](#--)
    + [장소 검색](#-----)
      - [MapFragment.kt](#mapfragmentkt)
    + [즐겨찾기](#----)
      - [LikePlaceFragment.kt](#likeplacefragmentkt)
  * [Server 부문](#server----1)
    + [Spring](#spring)
    + [Flask](#flask)
- [Petmily Flask 서버](#petmily-flask---)
  * [개요](#--)
      - [라이브러리 import, 모델 초기 세팅](#------import----------)
      - [개와 고양이를 찾아주는 기능](#---------------)
      - [고양이의 품종을 분류하는 기능](#----------------)
    + [머신러닝](#----)
    + [학습 코드 설명](#--------)
      - [load_datasets 함수](#load-datasets---)
